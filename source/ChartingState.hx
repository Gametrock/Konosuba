	...
	**/
	...
	function updateGrid():Void
	{
		...
		for (i in sectionInfo)
		{
			...
			var note:Note = new Note(daStrumTime, daNoteInfo % 4, null, false, daDamage);
	...
	private function addNote(?n:Note, ?damageNote:Bool = false):Void
	{
		...
		if (n != null)
			_song.notes[curSection].sectionNotes.push([n.strumTime, n.noteData, n.sustainLength, n.damageNote]);
		else
			_song.notes[curSection].sectionNotes.push([noteStrum, noteData, noteSus, damageNote]);
