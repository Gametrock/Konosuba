...
class HealthIcon extends FlxSprite
{
	...
	public function new(char:String = 'bf', isPlayer:Bool = false)
	{
		...
		animation.add('aqua', [24, 25, 53], 0, false, isPlayer);
		animation.add('darkness', [28, 29, 54], 0, false, isPlayer);
		animation.add('megumin', [26, 27, 55], 0, false, isPlayer);
		animation.add('meguminplayable', [26, 27, 55], 0, false, isPlayer);
		animation.play(char);
		switch(char){
